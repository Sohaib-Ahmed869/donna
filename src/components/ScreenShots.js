              ...
              <div className="work-pra" style={{ color: 'white' }}>
                <ul className="inline-item">
                  <li className="list-inline-item">
                    <p  style={{ fontSize: '1.3rem' }}>LIVE workout every morning at 6.30 am
                  ...
                  <li className="list-inline-item">
                    <p style={{ fontSize: '1.3rem' }}>This program is for people who want to train consistently with the best in the business all from the comfort of their own home.</p>
                  </li>
                  <li className="list-inline-item">
                    <p style={{ fontSize: '1.3rem' }}>You need a fitness mat & a set of dumbbells & a Kettlebell. When you are training a long time with me you can invest in a fitness step and a weighted vest to add additional resistance & challenge.</p>
                  </li>
                  <li className="list-inline-item">
                    <p style={{ fontSize: '1.3rem' }}>This program runs all the time so you can start whenever suits you and you are not tied into any contract or committed to any length of time – stay as long as you like</p>
                  </li>
                </ul>
              </div>
            </Col>
